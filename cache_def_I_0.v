...
`define VALID_BIT_SIZE 	2

// Cache line segregation calculation of Index / Valid / VALID_BIT / Tag / Data / Blk_offset sizes
...
`define CACHE_TAG_VALID_SIZE 	((`TAG_SIZE) + (`VALID_BIT_SIZE))
...
`define CACHE_VALID_BIT_MSB   ((`VALID_BIT_SIZE) - 1)
`define CACHE_VALID_BIT_LSB   0
